...
public class OOP_5 {
    ...
    public static void main(String[] args) {
        ...
        List<Creature> Team_A = FillTeamA(9);
        for (Creature creature : Team_A) {
            System.out.println(creature.getInfo());

        }
        List<Creature> Team_B = FillTeamB(9);
    ...
    public static List<Creature> FillTeamA(int countMemeber) {
        String[] names = { "Carington", "Darkfury", "Howlux", "Weedle", "Gadar", "Spencer", "Bremar", "Mikoto", "Jabba"};
        ...
        for (int i = 0; i < countMemeber + 1; i++) {
            ...
            switch (cs) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    squad.add(new Wizard(names[random.nextInt(names.length)]));
                default:
                    break;
            }
        }
